...
ULong loongarch64_calculate_fclass_d ( ULong src )
{
   ...
   if ((f & 0x7fffffffffffffffUL) == 0x7ff0000000000000UL) {
      return sign ? 1 << 2 : 1 << 6;
   } else if ((f & 0x7fffffffffffffffUL) == 0) {
      return sign ? 1 << 5 : 1 << 9;
   } else if ((f & 0x7ff0000000000000UL) == 0) {
      return sign ? 1 << 4 : 1 << 8;
   } else if ((f & ~(1UL << 63)) > 0x7ff0000000000000UL) {
      return ((f << 1) >= 0xfff0000000000000UL) ? 1 << 1 : 1 << 0;
   } else {
      return sign ? 1 << 3 : 1 << 7;
   }
}
